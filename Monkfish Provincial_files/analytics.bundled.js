...
s.linkTrackVars = "prop1,prop5,prop6,prop8,prop12,prop13,prop14,prop17,prop18,prop19,prop20,prop22,prop23,prop24,prop32,prop33,prop34,prop37,prop38,prop39,prop41,prop42,prop50,"
    + "eVar1,eVar4,eVar6,eVar7,eVar8,eVar9,eVar10,eVar11,eVar14,eVar15,eVar16,eVar21,eVar23,eVar24,"
    + "events";
s.linkTrackEvents = "event9,event10,event11,event12,event16,event17,event22";
/* Plugin Config */
s.usePlugins = true;
function s_doPlugins(s) {
	
	// set versions
	s.prop50="1.2.1|20150427"
...
//
var ComscoreShim=function(a,d){var c={};var b=function(f){return f in c};var e=function(h,f,g){if(f.indexOf("infinite scroll down")<0||b(g)){return
}c[g]=true;if(typeof window.COMSCORE!=="undefined"){window.COMSCORE.beacon({c1:"2",c2:"6036305"})}};d.listen("An.Event.ToBe.Tracked","ComscoreShim.SendBeacon",e)
};
//
// source/js/analytics/omniture-shim.js
//
"use strict";var OmnitureShim=function(a,c,d,b){OmnitureShim.init(a,c,d,b)};OmnitureShim.allrecipesOmnitureMappings={pageName:"event1","Login Started":"event16","Login Completed":"event17","Free Registration Started":"event11","Free Registration Completed":"event12","Action Complete":"event10","Error Message":"event22"};
...
if(d&&d.createIfUndefined&&d.value){a[c]=d.value}else{if(a[c]&&a[c]!=="function"){a[c]=d.value}}}}};OmnitureShim.init=function(a,c,d,b){OmnitureShim.dl=a;
OmnitureShim.omnitureApi=c;OmnitureShim.omnitureApi.eventsAr=[];OmnitureShim.pubsub=d;if(!OmnitureShim.dl.IsTrackingDisabled&&b!==true){OmnitureShim.SetSCodeProps(a,c);
...
})};OmnitureShim.sendBeacon=function(b){var a=OmnitureShim.getCurrentEvent(OmnitureShim.dl,b);OmnitureShim.SetSCodeProps(OmnitureShim.dl,OmnitureShim.omnitureApi,a);
OmnitureShim.omnitureApi.events=OmnitureShim.omnitureApi.eventsAr.join(",");if(a.OmnitureOverride){OmnitureShim.FullOverride(a.OmnitureOverride,OmnitureShim.omnitureApi)
}if(StringHelper.IsNullOrEmpty(a.eventType)){OmnitureShim.omnitureApi.tl(OmnitureShim.omnitureApi,"o",a.eventInfo.eventName)}else{switch(a.eventType){case"spa_page_load":OmnitureShim.omnitureApi.t();
break;default:OmnitureShim.omnitureApi.tl(OmnitureShim.omnitureApi,"o",a.eventInfo.eventName);break}}OmnitureShim.resetOmnitureEvents(OmnitureShim.omnitureApi)
};OmnitureShim.getCurrentEvent=function(a,b){var c=a.event.length-1;for(;c>=0;c-=1){if(a.event[c].uid==b){return a.event[c]}}return null
};OmnitureShim.resetOmnitureEvents=function(a){a.eventsAr=[];a.eVar7="";a.eVar8="";a.eVar9="";a.eVar24="";a.prop24=""};OmnitureShim.SetSCodeProps=function(b,c,a){if(!b){return
}if(b.externalLinkId){OmnitureShim.omnitureApi.campaign=OmnitureShim.omnitureApi.prop11=b.externalLinkId}OmnitureShim.SetPageInfoProps(b,c);
OmnitureShim.SetPageIngredientSearchProps(b,c);OmnitureShim.SetPageCategoryProps(b,c);OmnitureShim.SetPageParameterProps(b,c);
...
};OmnitureShim.SetPageInfoProps=function(a,b){if(!a.page||!a.page.pageInfo){return}if(a.page.pageInfo.pageId){b.prop32=a.page.pageInfo.pageId
}if(a.page.pageInfo.pageTitle){b.contextData.pagetitle=a.page.pageInfo.pageTitle}if(a.page.pageInfo.destinationURL){b.contextData.url=a.page.pageInfo.destinationURL
}if(a.page.pageInfo.domain){b.prop38=a.page.pageInfo.domain;b.eVar15=a.page.pageInfo.domain}if(a.page.pageInfo.onSiteSearchTerm){b.prop17=a.page.pageInfo.onSiteSearchTerm;
b.eVar11=a.page.pageInfo.onSiteSearchTerm}if(a.page.pageInfo.onSiteSearchResults){b.prop14=a.page.pageInfo.onSiteSearchResults
}if(a.page.pageInfo.sysEnv){b.server=a.page.pageInfo.sysEnv}if(a.page.pageInfo.pageName){b.pageName=a.page.pageInfo.pageName;
b.eVar1=a.page.pageInfo.pageName}if(a.page.pageInfo.variant){b.eVar13=a.page.pageInfo.variant}b.prop22=a.page.pageInfo.hourOfDay;
b.prop23=a.page.pageInfo.dayOfWeek;b.prop37=a.page.pageInfo.viewOrientation;b.prop39=a.page.pageInfo.pageLoadTime};OmnitureShim.SetPageCategoryProps=function(a,b){if(!a.page||!a.page.category){return
}if(a.page.category.contentType){b.prop6=a.page.category.contentType}if(a.page.category.primaryCategory){b.channel=a.page.category.primaryCategory
}if(a.page.category.adZone){b.prop5=a.page.category.adZone}if(a.page.category.adKeys){b.prop8=a.page.category.adKeys;b.eVar4=a.page.category.adKeys
}if(a.page.category.contentSource){b.prop20=a.page.category.contentSource}};OmnitureShim.SetPageIngredientSearchProps=function(a,d){if(!a.page||!a.page.pageInfo){return
}var c=a.page.pageInfo.onSiteSearchIncludedIngredients;var b=a.page.pageInfo.onSiteSearchExcludedIngredients;if(c){d.prop12=c.length>0?c[0].trim():null;
d.prop13=c.length>1?c[1].trim():null}if(b){d.prop18=b.length>0?b[0].trim():null;d.prop19=b.length>1?b[1].trim():null}if((c||b)&&a.page.pageInfo.queryStringParameters){d.eVar14=a.page.pageInfo.queryStringParameters
...
}}if(a.page.pageInfo.parameters.linkName){b.prop34=a.page.pageInfo.parameters.linkName}}}};OmnitureShim.SetUserProps=function(a,b){if(!a.user||a.user.length<1){return
}if(a.user[0].segment){b.eVar10=a.user[0].segment.visitorType;b.eVar6=a.user[0].segment.loginStatus}if(a.user[0].profile&&a.user[0].profile.length>0){if(a.user[0].profile[0].profileInfo){b.prop33=a.user[0].profile[0].profileInfo.profileId;
...
}};OmnitureShim.setEventInfo=function(a,c,b){if(b.eventInfo){if(b.eventInfo.eventName){c.eVar8=b.eventInfo.eventName}if(b.eventInfo.eventAction){c.eventsAr.push(OmnitureShim.allrecipesOmnitureMappings[b.eventInfo.eventAction])
}if(b.eventInfo.errorText){c.eVar24=b.eventInfo.errorText}}if(b.attributes){if(b.attributes.pageName){c.eventsAr.push(OmnitureShim.allrecipesOmnitureMappings[b.attributes.pageName])
}if(b.attributes.itemId){c.eVar9=b.attributes.itemId}if(b.attributes.paginatedUrl){c.eVar1=b.attributes.paginatedUrl}if(b.attributes.clickId){c.eVar16=b.attributes.clickId;
c.oid=b.attributes.clickId}if(b.attributes.internalSource){c.prop24=b.attributes.internalSource}}if(a.page.category){if(a.page.category.contentType){c.eVar7=a.page.category.contentType
}}if(a.page.attributes){if(a.page.attributes.contentId){c.eVar23=a.page.attributes.contentId}}};OmnitureShim.SetNewsletterProps=function(a,b){if(!a.newsletter){return
}if(a.newsletter.mailingId){b.prop25=a.newsletter.mailingId}if(a.newsletter.mailingName){b.prop26=a.newsletter.mailingName}if(a.newsletter.mailingDate){b.prop27=a.newsletter.mailingDate
...
}if(b.prop26&&b.prop27){b.eVar5=b.prop26+"_"+b.prop27}};
//
// source/js/analytics/krux-shim.js
//
var KruxShim=function(a,c){var d=this;var b=[];b.SocialShareStart={Id:"JOv1lOzu",Name:"SocialShareStart",EventType:"cact"};b.VideoStart={Id:"JOv2xW41",Name:"VideoStart",EventType:"cact"};
b["Recipe.AddToRecipeBox"]={Id:"JOv3FPm8",Name:"Recipe.AddToRecipeBox",EventType:"cact"};b.ShoppingListSave={Id:"JOv3gD_c",Name:"ShoppingListSave",EventType:"cact"};
b.IMadeIt={Id:"Jj4-pZQF",Name:"IMadeIt",EventType:"clk"};this.TrackEvent=function(f){if(a&&!a.IsTrackingDisabled&&(f in b)){var e=b[f];
var g="http://beacon.krxd.net/event.gif?event_id="+e.Id+"&event_type="+e.EventType;(new Image()).src=g}};c.listen("SocialShareStart","KruxShim.TrackSocialStart",function(){d.TrackEvent("SocialShareStart")
});c.listen("VideoStart","KruxShim.TrackVideoStart",function(){d.TrackEvent("VideoStart")});c.listen("Recipe.AddToRecipeBox","KruxShim.TrackRecipeSave",function(){d.TrackEvent("Recipe.AddToRecipeBox")
});c.listen("ShoppingListSave","KruxShim.TrackShoppingListSave",function(){d.TrackEvent("ShoppingListSave")});c.listen("IMadeIt","KruxShim.TrackIMadeIt",function(){d.TrackEvent("IMadeIt")
})};
//
