	...
	*/
    ...
    invite : {
        ...
        dialogs : [[{
            ...
            blurb: "Thanks for visiting Allrecipes. It's home cooks like you that have made Allrecipes such an amazing cooking resource. We'd love to ask a few questions about your visit today so we can learn how to improve your experience.",
            noticeAboutSurvey: "If you select 'yes' below,  we will present you with our customer satisfaction survey at the conclusion of your visit",
            attribution: "This survey is conducted by an independent company ForeSee, on behalf of Allrecipes.",
...
*/
        ...
        exclude : {
            urls:['/signup', '/membership', '/checkout', 'http://allrecipes.com/features/menu-planner-2.aspx', '/Membership/Signup.aspx', '/supportingmembership/info.aspx'],
            referrers:[],
            userAgents:[],
            browsers:[],
            cookies:[],
