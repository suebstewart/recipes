...
//
// source/js/ads/ad-manager.js
//
var AR=AR||{};AR.Ads=AR.Ads||{};var googletag=googletag||{};googletag.cmd=googletag.cmd||[];(function(){var a=document.createElement("script");
a.async=true;a.type="text/javascript";var c="https:"==document.location.protocol;a.src=(c?"https:":"http:")+"//www.googletagservices.com/tag/js/gpt.js";
var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b);googletag.mdpScriptCalled=true})();AR.Ads.AdManager=function(c){var u=this;
var F=0;var e=768;var d=410;var f="div-gpt-ad-pushdown";var t=false;var w=false;var b=function(){var H=document.documentElement;
F=window.innerWidth-H.clientWidth};var g=function(I){var H=window.innerWidth<e||window.innerHeight<d;return(!H)?I.replace(/^ar.mobile/,"ar"):I
};var a=function(K){if(F==0||!Array.isArray(K)||K.adjustedWidths){return}try{for(var J=0;J<K.length;J++){var H=K[J][0][0]-F;if(H>0){K[J][0][0]=H
}}}catch(I){console.log(I)}finally{K.adjustedWidths=true}return};var h=function(J,I,N){var H="/3865/"+g(I)+(N?("/"+N):"");if(H.indexOf("null")>=0){return
}var K=$("#"+J.slotId);if(K.count==0){return}var M=($(window).width()<(e-F));if(K.parents().hasClass("ad-non-mobile-only")&&M){w=true;
return}else{if(K.parents().hasClass("ad-mobile-only")&&!M){return}}var L;if(J.isInterstitial===true){L=googletag.defineOutOfPageSlot(H,J.slotId)
}else{L=googletag.defineSlot(H,J.size,J.slotId);t=t||(J.slotId==f)}x=u.GetVendorByName("pubmatic");if(x.Enabled){x.Manager.SetSlotTargeting(J,L)
}G=u.GetVendorByName("yieldbot");if(G.Enabled){G.Manager.SetSlotTargeting(J,L)}if(J.sizeMapping){a(J.sizeMapping);L.defineSizeMapping(J.sizeMapping)
}L.addService(googletag.pubads());u.RegisteredSlots[J.slotId]=L};var i=function(){for(var H=0;H<u.Slots.length;++H){h(u.Slots[H],c.settings.site,c.settings.zone)
}};var j=function(){for(var H=0;H<u.sponsoredSlots.length;++H){h(u.sponsoredSlots[H],c.settings.sponsoredSite,u.sponsoredSlots[H].zone)
}};var o=function(){googletag.pubads().enableSingleRequest();googletag.pubads().disableInitialLoad();googletag.pubads().enableAsyncRendering();
googletag.pubads().collapseEmptyDivs();googletag.pubads().addEventListener("slotRenderEnded",E);googletag.pubads().addEventListener("slotRenderEnded",C);
googletag.pubads().addEventListener("slotRenderEnded",window.removeLockOnResponsiveAdSlotRequests);googletag.enableServices()
};var A=0;var s=false;var v=true;var y=false;var z=false;var r=0;var p=0;var C=function(H){if(!t||y){return}var I=(H.slot.getSlotId().d==f);
if(I){var J=$("#"+f);if(J&&J.html()&&J.css("display")!=="none"){var K=J.parent();if(K){K.css("display","block")}}y=true}};var E=function(H){A++;
if(H){if(H.isEmpty){var K=$("#"+H.slot.getSlotId().getDomId()).parents("[data-ad-container-autocollapse]");if(K.length){K.hide()
}var I=$("#"+H.slot.getSlotId().getDomId()).parents("[data-ad-container-masonry-autocollapse]");var J=$("#"+H.slot.getSlotId().getDomId()).data("sponsored-slot");
if(I.length&&!J){I.hide();s=true}}}if(!s){return}if(v){if(w){r=1;p=u.Slots.length-($("article[data-ad-container-masonry-autocollapse]").length-1)
}else{r=$(".gridad").length;p=u.Slots.length}if(p!==A){return}z=true;v=false}else{if(A!==r){return}z=true}if(!z){return}window.pubsub.broadcast("MasonryGridReload");
if(window.console.error){window.console.error("Masonry grid is being reloaded due to an ad slot not being targeted.")}A=0;s=false;
z=false};this.IsInitialized=false;this.IsInitializedByPubmatic=false;this.Initialize=function(){this.IsInitialized=true;G=u.GetVendorByName("yieldbot");
if(G.Enabled){G.Manager.InjectHeadScript();G.Manager.RegisterSlots();G.Manager.InitializeGpt(u)}else{u.InitializeGpt()}};this.InitializeGpt=function(){googletag.cmd.push(function(){b();
i();j();l();o();m()})};this.IsVendorEnabled=function(H){return(u.Vendors.filter(function(I){return I.Name.toLowerCase()===H.toLowerCase()&&I.Enabled===true
}).length>0)};this.GetVendorByName=function(H){var I=(u.Vendors.filter(function(J){return J.Name.toLowerCase()===H.toLowerCase()
}));return(I.length>0)?I[0]:{}};var m=function(){var J=u.Slots;var L=u.sponsoredSlots;var K=[];for(var I=0;I<J.length;I++){googletag.display(J[I].slotId);
var H=u.RegisteredSlots[J[I].slotId];if(typeof H!="undefined"){K.push(H)}}googletag.pubads().refresh(K);for(var I=0;I<L.length;
I++){googletag.display(L[I].slotId);var H=u.RegisteredSlots[L[I].slotId];if(typeof H!="undefined"){googletag.pubads().refresh([H])
}}};this.DoWork=function(J){if(u.Slots.length<1){return}var I=u.GetVendorByName("krux");if(I.Enabled){I.Manager.InjectInterchangeTagConfig();
I.Manager.InjectControlTag(J);I.Manager.AddKruxTargeting(u)}var H=x.Enabled&&x.Delay?x.Delay:0;setTimeout(function(){if(u.IsInitialized){return
}u.IsInitializedByPubmatic=false;u.Initialize()},H)};c=c||{};this.Slots=c.slots||[];this.sponsoredSlots=c.sponsoredSlots||[];
this.Vendors=c.vendors||[];this.PubmaticDelay=c.pubmaticDelay||300;this.PageTargets=c.pagetargets||[];this.RegisteredSlots=[];
this.DynamicSlots={};var B="div-gpt-ad-recipe-grid-responsive-";this.IsRecipeCardSponsorLogoOn=false;if(c.settings){this.Settings={responsiveGridSlots:(c.settings.responsiveGridSlots||0),site:(c.settings.site||""),sponsoredSite:(c.settings.sponsoredSite||""),zone:(c.settings.zone||"")}
}else{this.Settings={responsiveGridSlots:0,site:"",sponsoredSite:"",zone:""}}var k=function(H){googletag.pubads().setTargeting(H.key,H.value)
};var l=function(){for(var H=0;H<u.PageTargets.length;H++){k(u.PageTargets[H])}};var x=u.GetVendorByName("pubmatic");if(x.Enabled){x.Manager.Initialize(u)
}var G=u.GetVendorByName("yieldbot");if(G.Enabled){c.slots.map(function(H){if(H.isYieldbotAd){G.Manager.YieldbotSlotIds.push(H.slotId)
}})}var q=function(){if(u.Slots===null||u.Slots.length<0){return null}var H=u.Slots.filter(function(I){return I.slotId.indexOf(B)>-1
});if((H===null||typeof H==="undefined"||H.length===0)){return null}return B+(Object.keys(u.DynamicSlots).length+1+H.length).toString()
};var D=function(I){var H=u.Slots.filter(function(J){return J.slotId===I});return H.length===1};this.AddDynamicGridSlot=function(I){if(!D(I)){return null
}var H=q();if(H===null){return null}this.DynamicSlots[H]=I;return H};this.DisplayDynamicGridSlot=function(I){var J=u.DynamicSlots[I];
var H;u.Slots.forEach(function(K){if(K.slotId===J){H=AR.Util.ObjectCloner.clone(K);H.slotId=I;return}});if(typeof H!="undefined"&&H!=null){G=u.GetVendorByName("yieldbot");
if(G.Enabled){ybotq.push(function(){n(H)})}else{n(H)}}};var n=function(H){googletag.cmd.push(function(){h(H,c.settings.site,c.settings.zone);
googletag.pubads().setTargeting("type","refresh");googletag.display(H.slotId);var I=u.RegisteredSlots[H.slotId];googletag.pubads().refresh([I])
})};this.displayDynamiclogo=function(H){googletag.cmd.push(function(){h(H,H.site,H.zone);googletag.pubads().setTargeting("type","refresh");
googletag.display(H.slotId);var I=u.RegisteredSlots[H.slotId];googletag.pubads().refresh([I])})};this.RefreshAd=function(H){if(H==""||u.RegisteredSlots[H]==null){return
}googletag.pubads().setTargeting("type","refresh");G=u.GetVendorByName("yieldbot");if(G.Enabled){ybotq.push(function(){googletag.cmd.push(function(){var J=u.Slots.filter(function(K){return K.slotId===H
});var I;if(J&&J.length>0){I=J[0];G.Manager.SetSlotTargeting(I,u.RegisteredSlots[H])}googletag.pubads().refresh([u.RegisteredSlots[H]])
})})}else{googletag.pubads().refresh([u.RegisteredSlots[H]])}}};
//
...
var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(b,d)})()};this.InjectInterchangeTagConfig=function(){window.Krux||((Krux=function(){Krux.q.push(arguments)
}).q=[]);(function(){function c(f){var e,d="kx"+f;if(window.localStorage){return window.localStorage[d]||""}else{if(navigator.cookieEnabled){e=document.cookie.match(d+"=([^;]*)");
return(e&&unescape(e[1]))||""}else{return""}}}var b=[];Krux.user=c("user");if(Krux.user){b.push("kuid="+Krux.user)}Krux.segments=c("segs")&&c("segs").split(",")||[];
for(var a=0;a<Krux.segments.length;a++){b.push("ksg="+Krux.segments[a])}Krux.dartKeyValues=b.length?b.join(";")+";":""})()};this.AddKruxTargeting=function(a){a.PageTargets.push({key:"ksg",value:(typeof window.Krux.segments==="string")?window.Krux.segments.split(","):window.Krux.segments});
a.PageTargets.push({key:"kuid",value:window.Krux.user})}};
//
// source/js/ads/vendor-yieldbot.js
//
var AR=AR||{};AR.Ads=AR.Ads||{};AR.Ads.Yieldbot=function(){var a=this;this.YieldbotSlotIds=[];this.RegisterSlots=function(){if(a.YieldbotSlotIds.length<1){return
}ybotq.push(function(){yieldbot.pub("e529");for(var b=0;b<a.YieldbotSlotIds.length;b++){yieldbot.defineSlot(a.YieldbotSlotIds[b])
}yieldbot.enableAsync();yieldbot.go()})};this.InjectHeadScript=function(){window.ybotq=window.ybotq||[];(function(){var b=document.createElement("script");
b.src="//cdn.yldbt.com/js/yieldbot.intent.js";var c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(b,c)
})()};this.SetSlotTargeting=function(b,c){if(b.isYieldbotAd){yieldbot.setSlotTargeting(b.slotId,c)}};this.InitializeGpt=function(b){if(typeof ybotq==="undefined"){b.initializeGpt()
}else{ybotq.push(function(){b.InitializeGpt()})}}};
//
// source/js/ads/vendor-pubmatic.js
//
var AR=AR||{};AR.Ads=AR.Ads||{};AR.Ads.Pubmatic=function(){var a=this;this.Initialize=function(b){var c=this.BuildPubmaticSlotIds(b.Slots);
if(c.length===0){return}this.RegisterSlotIds(c,b);this.InjectHeadScript()};this.InjectHeadScript=function(){(function(){var c=document.createElement("script");
c.async=true;c.src="//ads.pubmatic.com/AdServer/js/gshowad.js";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(c,b)
})()};this.BuildPubmaticSlotIds=function(c){if(!Array.isArray(c)){return[]}var d=c.filter(function(g){var e=false;var f=g.pubmaticSizes;
if(Array.isArray(f)&&f.length>0){e=f.every(function(i){var h=Array.isArray(i)&&i.length==2&&!isNaN(i[0])&&!isNaN(i[1]);return h
})}return e}).map(function(e){var f=e.pubmaticSizes.map(function(g){var h=e.slotId+"@"+g[0]+"x"+g[1];return h});e.pubmaticSlotIds=f;
return f});var b=[].concat.apply([],d);return b};this.RegisterSlotIds=function(c,b){window.pm_pub_id="37576";window.pm_optimize_adslots=c;
window.pm_async_callback_fn="pm_async_callback";window.pm_async_callback=function(){a.InitializeGpt(b)}};this.InitializeGpt=function(b){if(b.IsInitialized){return
}b.IsInitializedByPubmatic=true;b.Initialize()};this.BuildSlotTarget=function(d,c){if(!c||!d.pubmaticSlotIds||d.pubmaticSlotIds.length===0){return{}
}var b=function(g){var f=Number(g);return f===NaN?-1:f};var e=d.pubmaticSlotIds.map(function(h){var i={};var g=c[h];if(!g){return i
}var f=g.split(";");if(f.length!==8){return i}i={bidstatus:f[1],bid:b(f[3]),bidid:f[5],};return i}).reduce(function(g,h){var f=Math.max(g.bid,h.bid)==g.bid?g:h;
return f});if(e.bid||e.bid===0){e.bid=e.bid.toFixed(4)}return e};this.SetSlotTargeting=function(d,e){var c=window.progKeyValueMap;
var f=this.BuildSlotTarget(d,c);for(var b in f){if(f.hasOwnProperty(b)){e.setTargeting(b,f[b])}}}};
//
